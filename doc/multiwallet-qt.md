...
Only requiring some minor changes is sanity.cpp.
...
Changes to sanity.cpp
----------------------
sanity.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
