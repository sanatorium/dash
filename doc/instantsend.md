...
This mechanism has been integrated into Bitcore-Node-Sanity which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/sanatorium/insight-api-sanity#web-socket-api](https://github.com/sanatorium/insight-api-sanity#web-socket-api)
* API: [https://github.com/sanatorium/insight-api-sanity#instantsend-transactions](https://github.com/sanatorium/insight-api-sanity#instantsend-transactions)
...
By default, the Sanity Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sanity Core daemon:
