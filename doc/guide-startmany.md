...
### Send 1000 SANITY to New Addresses

Send exactly 1000 SANITY to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 SANITY.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 SANITY on the remote server and defeats the purpose of a hot/cold setup.*
