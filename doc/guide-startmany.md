...
### Send 10000 SANITY to New Addresses

Send exactly 10000 SANITY to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 10000 SANITY.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 10000 SANITY on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the sanity github repo](https://github.com/sanatorium/sanity/blob/master/doc/masternode_conf.md)
...
## Update sanity.conf on server

If you generated a new masternode private key, you will need to update the remote `sanity.conf` files.
...
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `sanity.conf` file.
...
```
sanity-cli masternode status
{
    "outpoint" : "<collateral_output>-<collateral_output_index>",
    "service" : "<ipaddress>:<port>",
    "pubkey" : "<10000 SANITY address>",
...
Search your Masternodes on https://sanityninja.pl/masternodes.html
