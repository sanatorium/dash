...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Sanity Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  sanity-cli [options] <command> [params]  " + _("Send command to Sanity Core") + "\n" +
                  "  sanity-cli [options] help                " + _("List commands") + "\n" +
                  "  sanity-cli [options] help <command>      " + _("Get help for a command") + "\n";
