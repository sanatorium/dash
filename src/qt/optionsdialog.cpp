    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SANITY-light"), QVariant("light"));
    ui->theme->addItem(QString("SANITY-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SANITY-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SANITY-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SANITY-traditional"), QVariant("trad"));
