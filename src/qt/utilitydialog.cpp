    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Sanity Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Sanity Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  sanity-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Sanity in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SANITY, 0.1 SANITY, 1 SANITY and 10 SANITY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://sanatorium.atlassian.net/wiki/display/DOC/PrivateSend\">https://sanatorium.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Sanity Core is shutting down...") + "<br /><br />" +
