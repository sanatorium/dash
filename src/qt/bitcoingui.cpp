    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sanity Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sanity address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sanity: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sanity Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sanity Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sanity Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sanity addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sanity addresses"));
    ...
    openAction->setStatusTip(tr("Open a sanity: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sanity Core help message to get a list with possible Sanity Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sanity Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sanity network", "", count));
    } else {
...
{
    QString strTitle = tr("Sanity Core"); // default title
