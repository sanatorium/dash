...
static const int64_t SPORK_5_INSTANTSEND_MAX_VALUE_DEFAULT              = 10000;        // 10000 SANITY
...
static const int64_t SPORK_10_MASTERNODE_PAY_UPDATED_NODES_DEFAULT      = 0; // MODMOD ON (was 4070908800ULL;// OFF)
