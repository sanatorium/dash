...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Sanity related functionality
...
/*
    ...
    allow endless transaction that would bloat Sanity and make it unusable. To
