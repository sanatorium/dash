...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SanityNetwork") type = SanityNetwork;
    if(strType == "SanityNetworkVariable") type = SanityNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SanityNetwork) s = "SanityNetwork";
    if(type == SanityNetworkVariable) s = "SanityNetworkVariable";
