 ...
 *
 *   // network
 *   CSanityNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sanity.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSanityNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SanityNetwork
// //   -- signature requirements : Key1(User)
// class CSanityNetworkVariable : public CGovernanceObject
// {
// private:
